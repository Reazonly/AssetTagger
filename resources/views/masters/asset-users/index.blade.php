...
<div class="bg-white rounded-xl shadow-lg p-6 md:p-8">
    ...
    <div class="mb-6">
        <form action="{{ route('master-data.asset-users.index') }}" method="GET">
            <div class="flex">
                <input type="text" name="search" placeholder="Cari nama, jabatan, departemen, atau perusahaan..." value="{{ request('search') }}" class="w-full md:w-1/3 border-gray-300 rounded-l-md shadow-sm py-2 px-3">
