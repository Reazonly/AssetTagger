...
@section('content')
    <form action="{{ route('master-data.companies.update', $company) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500 mt-1">Perbarui detail untuk: <span class="font-semibold">{{ $company->name }}</span></p>
        </div>
        ...
        <div class="bg-white p-8 rounded-lg shadow-md border">
            <div class="space-y-6 max-w-lg">
                ...
                <div>
                    ...
                    <input type="text" name="code" id="code" value="{{ old('code', $company->code) }}" required maxlength="10"
                           class="mt-1 block w-full border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-sky-500 focus:border-sky-500">
        ...
        <div class="mt-8 pt-6 border-t flex justify-end items-center gap-3">
            ...
            <button type="submit" class="bg-sky-600 text-white font-semibold px-5 py-2 rounded-lg hover:bg-sky-700 shadow-md">Simpan Perubahan</button>
        </div>
    </form>
@endsection