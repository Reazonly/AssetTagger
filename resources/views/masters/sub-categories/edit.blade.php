...
<div class="mt-6" x-data="{ specFields: {{ json_encode(old('spec_fields', $subCategory->spec_fields ?? [['name' => '', 'type' => 'text']])) }} }">
    ...
    <template x-for="(field, index) in specFields" :key="index">
        <div class="flex items-center gap-2 mb-2">
            ...
            <button type="button" @click="specFields.splice(index, 1)" class="p-2 text-red-500 hover:bg-red-100 rounded-full">
