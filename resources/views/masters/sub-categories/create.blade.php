...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        <a href="{{ route('master-data.sub-categories.show', $category->id) }}" class="text-sm font-semibold text-gray-600 hover:text-gray-900">&larr; Kembali</a>
        ...
        <form action="{{ route('master-data.sub-categories.store', $category->id) }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div class="pt-4 border-t">
                    ...
                    <p class="text-xs text-gray-500 mb-3">Tambahkan field input yang akan muncul di form aset jika sub-kategori ini dipilih. Contoh: Processor, RAM, Ukuran Layar.</p>
