        ...
        <form action="{{ route('users.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nama_pengguna" id="nama_pengguna" value="{{ old('nama_pengguna') }}" required class="block w-full border-2 border-gray-400 rounded-md shadow-sm py-2 px-3 shadow-sm py-2 px-3 @error('nama_pengguna') border-red-500 @enderror">
                    @error('nama_pengguna') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>

                <div class="md:col-span-2">
                    <label for="email" class="block text-sm font-medium text-gray-700">Alamat Email</label>
                    <input type="email" name="email" id="email" value="{{ old('email') }}" required class="block w-full border-2 border-gray-400 rounded-md shadow-sm py-2 px-3 shadow-sm py-2 px-3 @error('email') border-red-500 @enderror">
                    @error('email') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>

                <div class="md:col-span-2">
                    <label for="roles" class="block text-sm font-medium text-gray-700">Role</label>
                    <select name="roles[]" id="roles" class="block w-full border-2 border-gray-400 rounded-md shadow-sm py-2 px-3 shadow-sm py-2 px-3 @error('roles') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="password" name="password" id="password" required class="block w-full border-2 border-gray-400 rounded-md shadow-sm py-2 px-3 shadow-sm py-2 px-3 @error('password') border-red-500 @enderror">
                    @error('password') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>

                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-700">Konfirmasi Password</label>
                    <input type="password" name="password_confirmation" id="password_confirmation" required class="block w-full border-2 border-gray-400 rounded-md shadow-sm py-2 px-3 shadow-sm py-2 px-3">
                </div>
            </div>
