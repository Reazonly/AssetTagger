...
<body class="bg-gray-100 text-gray-900">
    ...
    <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-3 rounded-lg transition-colors duration-200 
        {{ request()->routeIs('dashboard') ? 'bg-jg-green text-white' : 'text-gray-600 hover:bg-white/20 hover:text-gray-800' }}">
    ...
    <a href="{{ route('assets.index') }}" class="mt-2 flex items-center px-4 py-3 rounded-lg transition-colors duration-200 
        {{ request()->routeIs('assets.*') ? 'bg-jg-green text-white' : 'text-gray-600 hover:bg-white/20 hover:text-gray-800' }}">
        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-white-100">
