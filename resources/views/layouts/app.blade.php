    ...
    <div x-data="{ isSidebarOpen: true }" class="flex h-screen bg-gray-100">
        ...
        <aside x-show="isSidebarOpen"
            ...
            <nav class="mt-6 flex-grow px-4">
                <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-3 rounded-lg transition-colors duration-200 {{ request()->routeIs('dashboard') ? 'bg-jg-green' : 'hover:bg-white/20' }}">
