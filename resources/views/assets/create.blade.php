    ...
    <form action="{{ route('assets.store') }}" method="POST">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white p-6 rounded-lg border shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-8">
                    <div>
                        ...
                        <input type="text" name="code_asset" id="code_asset" value="{{ old('code_asset') }}" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500" required>
                    </div>
                    <div>
                        <label for="nama_barang" class="block text-sm font-medium text-gray-600">Nama Barang</label>
                        <input type="text" name="nama_barang" id="nama_barang" value="{{ old('nama_barang') }}" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500" required>
                    </div>
                    <div>
                        <label for="merk_type" class="block text-sm font-medium text-gray-600">Merk/Tipe</label>
                        <input type="text" name="merk_type" id="merk_type" value="{{ old('merk_type') }}" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500">
                    </div>
                    <div>
                        <label for="serial_number" class="block text-sm font-medium text-gray-600">Serial Number</label>
                        <input type="text" name="serial_number" id="serial_number" value="{{ old('serial_number') }}" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="lokasi" id="lokasi" value="{{ old('lokasi') }}" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg border shadow-sm">
                ...
                <div>
                    <label for="user_id" class="block text-sm font-medium text-gray-600">Pilih Pengguna Awal</label>
            ...
            <div class="bg-white p-6 rounded-lg border shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-x-6 gap-y-8">
                    <div>
                        ...
                        <input type="text" name="processor" id="processor" value="{{ old('processor') }}" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500">
                    </div>
                    <div>
                        <label for="memory_ram" class="block text-sm font-medium text-gray-600">RAM</label>
                        <input type="text" name="memory_ram" id="memory_ram" value="{{ old('memory_ram') }}" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500">
                    </div>
                    <div>
                        <label for="hdd_ssd" class="block text-sm font-medium text-gray-600">Storage (HDD/SSD)</label>
                        <input type="text" name="hdd_ssd" id="hdd_ssd" value="{{ old('hdd_ssd') }}" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500">
                    </div>
                    <div>
                        <label for="graphics" class="block text-sm font-medium text-gray-600">VGA/Graphics</label>
                        <input type="text" name="graphics" id="graphics" value="{{ old('graphics') }}" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500">
                    </div>
                    <div>
                        <label for="thn_pembelian" class="block text-sm font-medium text-gray-600">Tahun Pembelian</label>
                        <input type="number" name="thn_pembelian" id="thn_pembelian" value="{{ old('thn_pembelian') }}" placeholder="Contoh: 2025" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500">
                    </div>
                    <div>
                        <label for="harga_total" class="block text-sm font-medium text-gray-600">Harga</label>
                        <input type="number" name="harga_total" id="harga_total" value="{{ old('harga_total') }}" placeholder="Contoh: 15000000" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500">
                    </div>
                    <div>
                        <label for="code_aktiva" class="block text-sm font-medium text-gray-600">Kode Aktiva</label>
                        <input type="text" name="code_aktiva" id="code_aktiva" value="{{ old('code_aktiva') }}" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500">
                    </div>
                    <div>
                        <label for="po_number" class="block text-sm font-medium text-gray-600">Nomor PO</label>
                        <input type="text" name="po_number" id="po_number" value="{{ old('po_number') }}" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500">
                    </div>
                    <div>
                        <label for="nomor" class="block text-sm font-medium text-gray-600">Nomor BAST</label>
                        <input type="text" name="nomor" id="nomor" value="{{ old('nomor') }}" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg border shadow-sm">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <textarea name="include_items" id="include_items" rows="3" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500">{{ old('include_items') }}</textarea>
                    </div>
                    <div>
                        <label for="peruntukan" class="block text-sm font-medium text-gray-600">Peruntukan</label>
                        <textarea name="peruntukan" id="peruntukan" rows="3" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500">{{ old('peruntukan') }}</textarea>
                    </div>
                    <div>
                        <label for="keterangan" class="block text-sm font-medium text-gray-600">Keterangan</label>
                        <textarea name="keterangan" id="keterangan" rows="3" class="mt-1 block w-full bg-transparent px-2 py-2 border-b-2 border-gray-300 focus:outline-none focus:border-emerald-500">{{ old('keterangan') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
