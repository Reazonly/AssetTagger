...
use PhpOffice\PhpSpreadsheet\Style\Border; // Import class Border
...
class TrackingReportExport implements FromCollection, WithHeadings, WithStyles, ShouldAutoSize
{
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        // Tentukan baris terakhir yang berisi data
        $highestRow = $sheet->getHighestRow(); 

        // Rentang data penuh (termasuk header)
        $fullRange = 'A1:' . $lastColumn . $highestRow;
        ...
        $styles = [
            ...
            // Override: Kode Aset, Nama Aset, Jabatan, & Perusahaan lebih baik rata kiri
            'A:B' => [
                'alignment' => [
            ...
            // Tambahkan Garis (Border) ke seluruh rentang data (Header + Data)
            $fullRange => [
                'borders' => [
                    'allBorders' => [
